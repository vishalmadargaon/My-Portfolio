...
const projects = [
  ...
  {
   title: 'Prompt Arena',
    pitch: 'Interactive platform for benchmarking, testing, and comparing LLM prompt responses side-by-side.',
    tech: ['Next.js 16', 'React 19', 'Tailwind CSS v4', 'Prisma', 'OGL', 'Framer Motion', 'GSAP'],
    feature: 'Real-time prompt evaluation featuring custom WebGL fluid dynamics, interactive shaders, and spring-animated layouts',
    image: '/images/Promptarena.png',
    link: '#',
    github: "#"
  }
];
