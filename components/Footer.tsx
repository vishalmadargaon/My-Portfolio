          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-8 pt-8">
                <a 
                  href="https://www.linkedin.com/in/vishal-madargaon-303503324/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center space-x-2 text-xs font-black uppercase tracking-widest hover:opacity-50 transition-opacity"
                >
                  <span>LinkedIn</span>
                  <ArrowUpRight size={14} />
                </a>
                <a 
                  href="https://github.com/vishalmadargaon" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center space-x-2 text-xs font-black uppercase tracking-widest hover:opacity-50 transition-opacity"
                >
